                ...
                <div class="contact-form-wrap">
                    <form action="#" method="post">
                        <div class="contact-left form-group msg_message">
                            <p>
                                <textarea name="msg_message" id="msg_message" cols="30" rows="12" placeholder="Mensaje *" class="form-control"></textarea>
                            </p>
                            
                        </div>
                        <div class="contact-right">
                            <div class="form-group msg_name">
                                <input type="text" name="msg_name" id="msg_name" placeholder="Ingresa tus nombres *" class="form-control">
                            </div>
                            <div class="form-group msg_email">
                                <input type="text" name="msg_email" id="msg_email" placeholder="Ingresa tu Email *" class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="text" name="msg_subject" id="msg_subject" placeholder="Ingrese el asunto" class="form-control">
                            </div>
                            <p id="cb-send-copy">
                                <input type="checkbox" value="" name="send-copy" id="contact-form-create-acc">
